                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-grow">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className={`px-3 py-1 text-sm font-medium rounded-full ${getMatchTypeStyle(book.matchType)}`}>
                            {getMatchTypeLabel(book.matchType)}
                          </span>
                        </div>
                        <p className="text-gray-600 mb-1">著者：{book.author}</p>
                        <p className="text-gray-500 text-sm">ジャンル：{book.genre}</p>
                      </div>
